...
async function main() {
  if (window.location.hash) {
    ...
    if ("h" in params) {
      ...
      password = prompt("Silahkan Masukan Password untuk membuka Situs Web ini :)");
    }
    ...
    try {
      ...
      error("APIKEY INVALID! Silahkan hubungi Owner untuk mendapatkan Apikey yang valid : wa.me/62895337278647");
    ...
    try {
      ...
      error("Link yang Corrupted tidak bisa didecrypt!");
      console.log(url);
      return;
    }
  } else {
